...
function(build_embeddings_lib)
	...
	if (CMAKE_C_COMPILER AND NOT _embeddings_cc)
		list(APPEND EMBEDDINGS_CARGO_ENV "CC=${CMAKE_C_COMPILER}")
	endif()
	if (CMAKE_CXX_COMPILER AND NOT _embeddings_cxx)
		list(APPEND EMBEDDINGS_CARGO_ENV "CXX=${CMAKE_CXX_COMPILER}")
	endif()
